...
namespace System.Threading
{
    ...
    public enum LazyThreadSafetyMode
    {
        ...
        /// accesses Value on this <see cref="System.Lazy{T}"/> instance, a <see cref="T:System.InvalidOperationException"/> will be thrown.
        /// </summary>
        None,
        ...
        /// subsequent accesses to Value. Also, if valueFactory recursively accesses Value on this <see cref="System.Lazy{T}"/> instance, a  <see cref="T:System.InvalidOperationException"/> will be thrown.
        /// </summary>
    ...
    public static class LazyInitializer
    {
        ...
        private static T EnsureInitializedCore<T>(ref T target, Func<T> valueFactory) where T : class
        {
            ...
            if (value == null)
            {
                throw new InvalidOperationException("The value factory method should not return a null value");
            }
    ...
    static class LazyHelpers<T>
    {
        ...
        private static T ActivatorFactorySelector()
        {
            ...
            {
                throw new MissingMemberException(string.Format("The type {0} does not have parameterless constructor", typeof(T).FullName));
            }
        }
    }
}